...
function AssigneeControl({
  ...
  const options = [assignee, currentUser, CLAUDE_AGENT_ACTOR]
      ...
      <div className="card-topline">
        ...
        {task.schedule && (
          <span
            ...
            title={text(
              "定时议题：到点自动执行，不被自动认领；确认本轮后回到等待认领等下一次；移入待立项会取消定时",
              "Scheduled issue: fires on time, never auto-claimed; confirming a round returns it to Todo; Backlog clears the schedule",
            )}
          >
            !
          </span>
