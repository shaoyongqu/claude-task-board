    ...
    >
      {panelOpen && (
        <section
          ...
          aria-label={text("Claude AI 对话", "Claude AI chat")}
          data-screen-label={text("Claude AI 对话", "Claude AI chat")}
        >
          <div
          ...
          >
            {loading && !snapshot ? (
              ...
              <>
                ...
                {snapshot.thread.status === "running" && (
                  <div className="ai-chat-running" role="status">
                    <span className="ai-chat-spinner" />
                    {text("Claude 正在处理", "Claude is working")}
                  </div>
                )}
                {retryableUserEvent && (
                  <button
              ...
              <div className="ai-chat-empty">
                ...
                <p>{projectId
                  ? text(
                    "Claude 会在新对话创建时记住当前项目。",
                    "Claude will remember the current project when it creates the new chat.",
                  )
          ...
          >
            ...
            <div className="ai-chat-input-wrap">
              ...
              <div
                ...
                data-placeholder={text("询问 Claude", "Ask Claude")}
                role="textbox"
                aria-label={text("发送给 Claude 的消息", "Message to Claude")}
                aria-multiline="true"
          ...
          {dangerConfirmOpen && (
            <div className="ai-chat-confirm-backdrop">
              <div className="ai-chat-confirm" role="alertdialog" aria-modal="true" aria-labelledby="ai-chat-confirm-title">
                ...
                <p>{text(
                  "本次消息允许 Claude 访问工作区之外的文件和命令。确认只对本次发送生效。",
                  "This message lets Claude access files and commands outside the workspace. This approval applies only to this message.",
                )}</p>
                <div>
